...
declare -a EXTENSION_GROUPS=(
    "通用|common|GitHub.copilot GitHub.copilot-chat openai.chatgpt anthropic.claude-code donjayamanne.githistory mhutchie.git-graph dbaeumer.vscode-eslint esbenp.prettier-vscode usernamehw.errorlens aaron-bond.better-comments christian-kohler.path-intellisense nonoroazoro.syncing oderwat.indent-rainbow wayou.vscode-todo-highlight formulahendry.code-runner ms-azuretools.vscode-docker redhat.vscode-yaml bradlc.vscode-tailwindcss"
...
# 提取通用扩展（用于交互模式的默认值）
DEFAULT_COMMON_EXTENSIONS="GitHub.copilot GitHub.copilot-chat openai.chatgpt anthropic.claude-code donjayamanne.githistory mhutchie.git-graph dbaeumer.vscode-eslint esbenp.prettier-vscode usernamehw.errorlens aaron-bond.better-comments christian-kohler.path-intellisense nonoroazoro.syncing oderwat.indent-rainbow wayou.vscode-todo-highlight formulahendry.code-runner ms-azuretools.vscode-docker redhat.vscode-yaml"
